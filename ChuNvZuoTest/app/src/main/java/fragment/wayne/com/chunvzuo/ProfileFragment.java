...
public class ProfileFragment extends Fragment {
    private ImageView iv_headphoto2;
    ...
    private void findId(View view) {
        iv_headphoto2 = (ImageView) view.findViewById(R.id.iv_headphoto2);
    }

    private void setListener() {
        iv_headphoto2.setOnClickListener(new View.OnClickListener() {
    ...
    protected void setImageToView(Intent data) {
        ...
        if (extras != null) {
            ...
            iv_headphoto2.setImageBitmap(photo);
            uploadPic(photo);
        }
    }
